...
public class Main {
	...
	public static void main(String[] args) {
		...
		// 왼족의 객체가 오른쪽의 클래스의 인스턴스냐(즉, 그 클래스로 만든 객체)
		// instanceof 연산자
		...
		p1=ch;              // 자동 형변환 // overriding한 상태에서 부모클래스의 method를 사용하기 위해
		ch=(ChildExam)p1;   // 형변환을 명시해줘야함
		
		// 자식은 부모의 method와 자기 자신의 method를 모두 사용
